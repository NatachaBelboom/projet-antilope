...
<main class="">
    ...
    <section class="layout__about about">
        <div>
            ...
            <a href="<?= get_permalink(noair_get_template_page('template-about')); ?>" class="about__link link">
    ...
    <section class="layout__pollution pollution">
        ...
        <div>
            <?= wp_get_attachment_image(get_field('pollution_img'),'large', false, array('class' => 'pollution__img')); ?>
        </div>
    </section>
