...
class MenuItem
{
    ...
    {
        return boolval($this->post->menu_item_parent); //evalue ce qu'on lui donne et retourne true ou false
    }
    ...
    public function isParentFor(MenuItem $instance)
    {
        return ($this->post->ID == $instance->getParentId()); /*comme si on avait fait un if return true, return false*/
    }

    public function addSubItem(MenuItem $instance)
    {
